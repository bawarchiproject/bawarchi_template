...
<main id="main" role="document">
	<section class="container-fluid">
		<article class="col-12">
	        ...
	        <pre><code>DocumentRoot &quot;C:\xampp\htdocs\Master_Builder\dist&quot;&lt;Directory &quot;C:\xampp\htdocs\Master_Builder\dist&quot;&gt;</code></pre><h3 id="greensock-tweenmax-and-timelinemax-optional-">GreenSock TweenMax and TimeLineMax <em>(optional)</em></h3>
	        ...
	        <ol>
	            <li>Open <code>package.json</code> file and change `Master_Builder the desired project name.  Do not use white spaces.  Hyphens and underscores are accepted.</li>
	            <li>Open <code>header.php</code> and <code>footer.php</code>.  Change <code>Master_Builder</code> to the project name that you chose in step 1.</li>
	            <li>Open your Command Prompt (Windows) or your Terminal (Mac OSX) and go to the directory of your project.</li>
	            <li>Run the following command: <code>npm install</code>.</li>
	            <li>Once that is completed, you&#39;re ready to rock and roll.  You can use the following commands during your development.</li>
	        </ol>
	        <h2 id="available-grunt-tasks">Available Grunt Tasks</h2>
	        <pre><code>grunt</code></pre><p><strong><em>Development Task:</em></strong> Generates the project dist folder for easy deployment to any server.  This command will not minify nor uglify your CSS and JS.  Recommended on initial start up of a project.</p>
	        <pre><code>grunt watch</code></pre><p><strong><em>Watch Task:</em></strong> Grunt will listen to any changes in your files will reload your page.  </p>
	        <pre><code>grunt dist</code></pre><p><strong><em>Production Task:</em></strong> Generates the project dist folder for easy deployment in any server.  This command will clean the <code>dist</code> folder, minify, uglify your CSS and JS, and compress your images.  In addition to this, Grunt will sift through the <code>header.php</code> and <code>footer.php</code> and will change the paths to the minified versions.  This will save you time changing them before going to deployment.  Recommended when your project is ready to go live.</p>
	        ...
	        <pre><code>grunt validate</code></pre><p><strong>Validation Task:_</strong> Will sift through your JS and SASS files to check for any errors.</p>
...
└── index.php
	        ...
	        <p><code>_scripts/</code> - <strong>Note:</strong> Any JavaScripts that you place into this root folder will not be concatenated in the build.  You must link it manually in <code>footer.php</code>.</p>
	        <p><code>_scripts/plugins/</code> - Place all plugin files in this folder. Grunt will concatenate it for you.</p>
	        <p><code>_scripts/plugins/minified/</code> - Place all minified files in this folder. Grunt will concatenate it for you.</p>
	        ...
	        <p><code>styles/</code> - Stylesheets from plugins are placed here.  <strong>Note:</strong> You must update <code>header.php</code> and link the CSS file.  CSS in this folder will not be concatenated with the ones you have created.</p>
	        ...
	        <h3 id="what-is-responsible-for-what">What Is Responsible For What</h3>
	        ...
	        <pre><code class="lang-javascript">line <span class="hljs-number">27</span>:    <span class="hljs-keyword">var</span> pdf = <span class="hljs-keyword">new</span> jsPDF(orientation, unit, format);</code></pre>
